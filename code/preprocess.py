...
def preprocess(debug, data_path, file_label_name, file_data_name, bert_version, data_type):
...
def main():
    ...
    preprocess(True, "/data/", "en-trial-wiki-20190121-cirrussearch-content.json.gz", "en_ENEW_LIST.json", "bert-base-cased", "entire")
